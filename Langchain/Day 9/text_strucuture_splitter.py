## Recursive Character Text Splitting ---> [ paragraph > sentence > word > character ]
...
text_1 = """My name is Ace,
This is my Ai playlist

The Current topic is langchain
It is on User side of AI"""

result_1 = splitter_1.split_text(text_1)
print(f"example = {result_1} \n")
...
text_2 = """One of the most important things I didn't understand about the world when I was a child is the degree to which the returns for performance are superlinear.
...
result_2 = splitter_2.split_text(text_2)
